...
description: Learn how to build a retail copilot application by deconstructing Contoso Chat, an open-source reference implementation built code-first on Azure AI, using a Retrieval Augmented Generation architecture.
template: splash
hero:
  tagline: Build a retail copilot code-first on Azure AI, using a Retrieval Augmented Generation (RAG) architecture. Learn to design, develop, evaluate, deploy & deliver, a custom generative AI solution end-to-end.
  image:
    file: ../../assets/logo.png
  actions:
    - text: Fork Sample
      link: https://github.com/Azure-Samples/contoso-chat/fork
      icon: github
      variant: secondary
    - text: Get Started
      link: about/
...
Contoso Chat is an open-source sample to teach you how to build a retail copilot (chat assistant) for your online retail website. The chat AI is designed to answer questions about the product catalog and to recommend items based on the customer's prior purchase history. By cloning the sample and completing the workshop, you will get hands-on experience with developer tools and the end-to-end workflow required to build modern generative AI solutions on Azure. Plus, you'll walk away with a functional sandbox that you can customize with your own data and requirements, and transfer the knowledge to your own solution domain.

---

![Sketchnote for Contoso Chat](./../../assets/contoso-chat-sketchnote.png)
